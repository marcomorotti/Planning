        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    TabIndex =2
                    Name ="fsubOcsaMstPO"
                    SourceObject ="Form.fsubOcsaMstPO"
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT  tblCOrders.DS_RAG_SOC FROM tblCOrders WHERE (((tblCOrders.Utente) like ["
                        "forms]![frmOcsaMst]![txtUtente] & \"*\"))  GROUP BY tblCOrders.DS_RAG_SOC UNION "
                        "select nullid as DS_RAG_SOC  from tblDummy ORDER BY tblCOrders.DS_RAG_SOC;"
                    ColumnWidths ="2886"
                ...
                Begin ComboBox
                    ...
                    Name ="txtNumero_Doc"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT  Numero_Doc FROM tblCOrders WHERE (((tblCOrders.Utente) like [forms]![frm"
                        "OcsaMst]![txtUtente] & \"*\" ))  GROUP BY tblCOrders.Numero_Doc UNION select nul"
                        "lid as Numero_Doc  from tblDummy ORDER BY tblCOrders.Numero_Doc;"
                    ColumnWidths ="2886"
                    AfterUpdate ="[Event Procedure]"
                    OnGotFocus ="[Event Procedure]"
...
On Error GoTo Err_cmdOpenMember_Click
    ...
    stLinkCriteria = "[COD_ART] = '" & Forms!frmOcsaMst!fsubOcsamst.Form.txtCod_Art & "'"
...
q = False
Call GenerateCsvOrders(Varwhere, q)
Exit Sub
End Sub

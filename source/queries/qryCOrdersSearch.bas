dbMemo "SQL" ="SELECT tblCOrders.liv_urgenza, tblCOrders.UTENTE, tblCOrders.NUMERO_DOC, tblCOrd"
    ...
    "to.COD_ART\015\012WHERE (((tblCOrders.Cod_Art) Like [forms]![fdlgOrdiniSearch]!["
    "txtCod_Art] & \"*\") AND ((tblCOrders.NUMERO_DOC) Like [forms]![fdlgOrdiniSearch"
    "]![txtNumero_Doc] & \"*\") AND ((tblCOrders.DS_RAG_SOC) Like [forms]![fdlgOrdini"
    "Search]![txtDS_RAG_SOC] & \"*\") AND ((tblCOrders.UTENTE) Like [forms]![fdlgOrdi"
    "niSearch]![txtUtente] & \"*\") AND ((tblCOrders.COD_CLI) Like [forms]![fdlgOrdin"
    "iSearch]![txtCOD_CLI] & \"*\")) and not exists (Select *                        "
    "   from tblCOrdersSpediz                           where tblCOrders.NUMERO_DOC ="
    " tblCOrdersSpediz.NUMERO_DOC_ORD                          AND tblCOrders.RIGA_DO"
    "C = tblCOrdersSpediz.RIGA_DOC_ORD)\015\012ORDER BY tblCOrders.liv_urgenza, tblCO"
    "rders.UTENTE, tblCOrders.NUMERO_DOC;\015\012"
dbMemo "Connect" =""
